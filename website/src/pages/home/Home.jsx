...
const NetProfitCard = memo(() => (
  <div
    className="bg-white rounded-10 p-15"
  >
    <div>
      <div className="flex items-center gap-8 mb-12">
        <div
          className="flex items-center justify-center icon bg-tertiary rounded-5"
        >
          <Icon name="Customers" width="12" height="12" stroke='var(--dark)' />
        </div>
...
const FinancialReportCard = memo(() => (
  <div
    className="rounded-10 p-15 bg-warning"
  >
    <h4 className="text-white font-600 mid-text">Lead Channels</h4>
...
const Home = () => {
        ...
        children: (
          <div className="grid-cols-3 gap-12 w-full">
            <div className="bg-white p-12 rounded-5">
              <h5 className="font-500 text-dark headmini-text">
                Top 3 Rankings
              </h5>
  ...
  return (
    <Container>
      <div className="flex gap-12 items-start w-full h-550 overflow-auto">
